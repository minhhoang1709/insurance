...
public class OrderConfirmRequestDto  implements Serializable{
	private static final long serialVersionUID = 7513133992061226418L;
	...
	public String toString() {
		return "OrderConfirmRequestDto [serviceCode=" + serviceCode + ", userRefNo=" + userRefNo + ", clientCode="
	...
	public static class RequestParam implements Serializable{
		private static final long serialVersionUID = 7893913094588075413L;
