...
public class ApiOrderServiceFamilyTest {
	...
	public void testChildCountInvalid(){
		...
		submitOrderDto.getFamilies().add(new PolicyOrderFamilyDto());
		submitOrderDto.getFamilies().get(0).setName("test");
		submitOrderDto.getFamilies().get(0).setBirthDate(LocalDateTime.now().minusYears(15));
		submitOrderDto.getFamilies().get(0).setRelationship(FamilyRelationship.ANAK);
		submitOrderDto.getFamilies().get(0).setGender(Gender.MALE);
		submitOrderDto.getFamilies().add(new PolicyOrderFamilyDto());
		submitOrderDto.getFamilies().get(1).setName("test");
		submitOrderDto.getFamilies().get(1).setBirthDate(LocalDateTime.now().minusYears(15));
		...
		submitOrderDto.getFamilies().get(2).setBirthDate(LocalDateTime.now().minusYears(15));
		submitOrderDto.getFamilies().get(2).setRelationship(FamilyRelationship.ANAK);
		...
		submitOrderDto.getFamilies().get(3).setRelationship(FamilyRelationship.ANAK);
	...
	public void testAdultCountInvalid(){
		...
		submitOrderDto.getFamilies().add(new PolicyOrderFamilyDto());
		submitOrderDto.getFamilies().get(0).setName("test");
		submitOrderDto.getFamilies().get(0).setBirthDate(LocalDateTime.now().minusYears(25));
		submitOrderDto.getFamilies().get(0).setRelationship(FamilyRelationship.ORANGTUA);
		submitOrderDto.getFamilies().get(0).setGender(Gender.MALE);
		submitOrderDto.getFamilies().add(new PolicyOrderFamilyDto());
		submitOrderDto.getFamilies().get(1).setName("test");
		submitOrderDto.getFamilies().get(1).setBirthDate(LocalDateTime.now().minusYears(25));
		submitOrderDto.getFamilies().get(1).setRelationship(FamilyRelationship.SAUDARA);
		submitOrderDto.getFamilies().get(1).setGender(Gender.MALE);
