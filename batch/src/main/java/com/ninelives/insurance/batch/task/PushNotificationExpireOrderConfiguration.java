...
@Configuration
public class PushNotificationExpireOrderConfiguration {
	private static final PushNotificationType PUSH_NOTIFICATION_TYPE = PushNotificationType.EXPIRE_ORDER;
	
	public static final String PUSH_NOTIFICATION_EXPIRE_ORDER_JOB = "pushNotificationExpireOrderJob";
	...
	public Job pushNotificationActiveOrderJob(
		...
		return jobBuilderFactory.get(PUSH_NOTIFICATION_EXPIRE_ORDER_JOB).start(step1(step1Reader, step1Writer))
	...
	public Step step1(ItemStreamReader<PushNotificationData> reader, ItemWriter<String> writer) {
		return stepBuilderFactory.get(PUSH_NOTIFICATION_EXPIRE_ORDER_JOB + "-step1")
	...
	public Step step2(ItemReader<PushNotificationData> reader, ItemWriter<PushNotificationData> writer){
		return stepBuilderFactory.get(PUSH_NOTIFICATION_EXPIRE_ORDER_JOB + "-step2")
	...
	public PushNotificationMyBatisReader<PushNotificationData> step1Reader() {	
        ...
        reader.setQueryId("com.ninelives.insurance.batch.mybatis.mapper.BatchMapper.selectExpireOrderForFcmNotification");
        return reader;
    }
