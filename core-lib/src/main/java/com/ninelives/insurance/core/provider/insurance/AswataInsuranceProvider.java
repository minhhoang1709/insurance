...
//	}
	...
	@Override
	public OrderResult orderPolicy(PolicyOrder order) throws IOException, StorageException, InsuranceProviderException{
		ResponseDto<OrderResponseDto> response = orderPolicyInternal(order);
	...
	public OrderConfirmResult orderConfirm(PolicyOrder order) throws InsuranceProviderException{
		ResponseDto<OrderConfirmResponseDto> response = orderConfirmInternal(order);
	...
	protected ResponseDto<OrderConfirmResponseDto> orderConfirmInternal(PolicyOrder order) throws InsuranceProviderException{
		if(!enableConnection){
			logger.error("Error on orderPolicy with exception <connection is not enabled>");
...
//	}
	...
	public void generatePolicy(PolicyOrder order) throws InsuranceProviderException {
		throw new InsuranceProviderMethodNotSupportedException("Policy is generated by Aswata");
	}	
